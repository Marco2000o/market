...
public class ProductController {
    ...
    @GetMapping("/all")
    //Autorizacion para ver los metodos en swagger
    ...
    public ResponseEntity<List<Product>> getCategoryById(@PathVariable("categoryId")    int categoryId){
        return productService.getCategory(categoryId).map(products -> new ResponseEntity<>(products,
